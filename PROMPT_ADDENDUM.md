> **Historisch contextaddendum.** Bij conflict gelden [`research/current.md`](research/current.md), [`research/constraints.md`](research/constraints.md), [`research/protocol.md`](research/protocol.md) en [`AGENTS.md`](AGENTS.md). MSI en XMG zijn later conditioneel heropend; dit document mag die actuele beslissingen niet terugdraaien.

# Addendum bij de oorspronkelijke marktonderzoeksopdracht
...
Before research read current, constraints, protocol and the candidate index.
